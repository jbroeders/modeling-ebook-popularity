...
if __name__ == '__main__':
    ...
    nlp_out = LSTM(16, return_sequences=True )(nlp_input)
    ...
    for bs in batch_size:
        for e in epochs:
            ...
            # model.fit({'nlp_input': X_nlp_train, 'meta_input': X_meta_train}, y_train, epochs=100, batch_size=64)

            model.fit({'nlp_input': X_nlp_train, 'meta_input': X_meta_train}, y_train, epochs=e, batch_size=bs, verbose=0)
